...
export const bigWeapons = [
    'minespawn:big_bertha', 'minespawn:stelix_bertha', 'minespawn:royal_guardian',
    'minespawn:queen_battle_axe', 'minespawn:battle_axe'
]
...
system.runInterval(() => {
    ...
    players.forEach(player => {
        ...
        if (player.getTags().includes('add_knockback_resistance')) {
            player.runCommand('event entity @s minespawn:add_kb_resistance');
            ...
            player.runCommand('event entity @s minespawn:remove_kb_resistance');
